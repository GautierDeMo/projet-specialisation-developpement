...
import { getCsrfToken } from '../services/csrf.js' // Importation du service CSRF
        ...
        <form id="register-form" class="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
            />
            <p class="text-xs text-gray-400 mt-1">8 caractères min, majuscule, chiffre et caractère spécial</p>
          </div>
